Obj_MonkeyBars:	; Obj_FBZChainLink
		move.b	$2C(a0),d0
		bpl.s	loc_3A7E6
		andi.w	#$3F,d0
		lsl.w	#4,d0
...
locret_3AD88:
		rts
; ---------------------------------------------------------------------------
Map_MonkeyBars:		binclude "Objects/Monkey Bars/Object Data/Map - Monkey Bars.bin"