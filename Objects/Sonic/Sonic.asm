...
+
	...
	.playerLUT:
		dc.l	Sonic_InstaAndShieldMoves, Sonic_InstaAndShieldMoves, Sonic_InstaAndShieldMoves
...
Animate_Player:
	...
	.aniRoutLUT:
		dc.l	Animate_Sonic, Animate_Tails, Animate_Knuckles
...
; ---------------------------------------------------------------------------
		...
		include "Objects/Sonic/Object Data/Map - Super Sonic.asm"
		include "Objects/Sonic/Object Data/Super Sonic pattern load cues.asm"