...
.delete:
		...
		include "Objects/Enemies/Badniks/Crabmeat/Object Data/Anim - Crabmeat.asm"
Map_Crabmeat:		binclude "Objects/Enemies/Badniks/Crabmeat/Object Data/Map - Crabmeat.bin"