...
ptr_Pal_DEZ:			palp	Pal_DEZ, Normal_palette_line_2, 48			; 7 - DEZ
ptr_Pal_TTZ:			palp	Pal_TTZ, Normal_palette_line_2, 48			; 8 - TTZ
; ---------------------------------------------------------------------------
...
palid_DEZ:				equ (ptr_Pal_DEZ-PalPointers)/8			; 7 - DEZ
palid_TTZ:				equ (ptr_Pal_TTZ-PalPointers)/8			; 8 - TTZ