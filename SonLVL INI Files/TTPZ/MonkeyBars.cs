...
{
	class MonkeyBars : ObjectDefinition
	{
		...
		public override void Init(ObjectData data)
		{
			...
			var art = LevelData.ReadFile("../Objects/Monkey Bars/KosinskiM Art/Monkey Bars.bin", CompressionType.KosinskiM);
			var map = System.IO.File.ReadAllBytes("../Objects/Monkey Bars/Object Data/Map - Monkey Bars.bin");
