...
namespace S3KObjectDefinitions.TTPZ
{
	class RideVine : ObjectDefinition
	{
		...
		public override void Init(ObjectData data)
		{
			...
			var art = LevelData.ReadFile("../Objects/Ride Vine/KosinskiM Art/Ride Vine.bin", CompressionType.KosinskiM);
			var map = System.IO.File.ReadAllBytes("../Objects/Ride Vine/Object Data/Map - Ride Vine.bin");
			var sprites = new[]
			{
