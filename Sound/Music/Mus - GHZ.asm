Snd_GHZ_Header:
	...
	smpsHeaderVoice     Snd_GHZ_Voices
	smpsHeaderChan      $06, $03
	smpsHeaderTempo     $01, $03

	smpsHeaderDAC       Snd_GHZ_DAC
	smpsHeaderFM        Snd_GHZ_FM1,	$F4, $12
	smpsHeaderFM        Snd_GHZ_FM2,	$00, $0B
	smpsHeaderFM        Snd_GHZ_FM3,	$F4, $14
	smpsHeaderFM        Snd_GHZ_FM4,	$F4, $08
	smpsHeaderFM        Snd_GHZ_FM5,	$F4, $20
	smpsHeaderPSG       Snd_GHZ_PSG1,	$D0, $01, $00, fTone_03
	smpsHeaderPSG       Snd_GHZ_PSG2,	$D0, $03, $00, fTone_06
	smpsHeaderPSG       Snd_GHZ_PSG3,	$00, $03, $00, fTone_04

; FM1 Data
Snd_GHZ_FM1:
	smpsSetvoice        $02
	smpsPan             panRight, $00
	smpsCall            Snd_GHZ_Call02
...
Snd_GHZ_Loop0D:
	dc.b	nC3, $08
	smpsLoop            $00, $1D, Snd_GHZ_Loop0D
	smpsNoteFill        $00
	dc.b	nC3, nD3, nE3

Snd_GHZ_Jump03:
	smpsSetvoice        $01
	smpsCall            Snd_GHZ_Call05
	smpsCall            Snd_GHZ_Call06
	smpsNoteFill        $00
	dc.b	nC3, nD3, nE3
	smpsCall            Snd_GHZ_Call05
	smpsCall            Snd_GHZ_Call06
...
Snd_GHZ_Loop04:
	...
	smpsLoop            $00, $02, Snd_GHZ_Loop04

Snd_GHZ_Loop05:
	dc.b	nA6, nE6, nC7, nE6, nA6, nE6, nC7, nE6
	smpsLoop            $00, $02, Snd_GHZ_Loop05

Snd_GHZ_Loop06:
	dc.b	nAb6, nEb6, nC7, nEb6, nAb6, nEb6, nC7, nEb6
	smpsLoop            $00, $02, Snd_GHZ_Loop06

Snd_GHZ_Loop07:
	dc.b	nC7, nA6, nE7, nA6, nC7, nA6, nE7, nA6
	smpsLoop            $00, $02, Snd_GHZ_Loop07
	smpsAlterVol        $0D
	smpsAlterPitch      $0C
	smpsJump            Snd_GHZ_Jump00
...
Snd_GHZ_Loop00:
	...
	smpsLoop            $00, $07, Snd_GHZ_Loop00
	dc.b	dKick, $10, dSnare, $08, dKick, $10, dSnare, $08, $08, $08

Snd_GHZ_Loop01:
	dc.b	dKick, $10, dSnare, $08, dKick, $10, $08, dSnare, $10
	smpsLoop            $00, $07, Snd_GHZ_Loop01
	dc.b	dKick, $10, dSnare, $08, dKick, $10, dSnare, $08, $08, $08
	smpsLoop            $01, $02, Snd_GHZ_Loop01
	smpsJump            Snd_GHZ_Loop01
