...
Sound5A:	include	"Sound/SFX/Snd - Explode.asm"
	even
Sound5B:	include	"Sound/SFX/Snd - Signpost Fall.asm"
	even
...
Sound5E:	include	"Sound/SFX/Snd - Super Transform.asm"
	even
Sound5F:	include	"Sound/SFX/Snd - Bata-pyon Spring.asm"
	even
...
Sound6A:	include	"Sound/SFX/Snd - Mecha Roll.asm"
	even
Sound6B:	include	"Sound/SFX/Snd - Mecha Dash.asm"
	even
Sound6C:	include	"Sound/SFX/Snd - Score Tally.asm"
	even
Sound6D:	include	"Sound/SFX/Snd - Signpost.asm"
	even
Sound6E:	include "Sound/SFX/Snd - Mecha-Bu Saw Lift.asm"
	even
Sound6F:	include	"Sound/SFX/Snd - Double Shield.asm"
	even
Sound70:	include	"Sound/SFX/Snd - Big Ring.asm"
	even
Sound71:	include	"Sound/SFX/Snd - Special Stage Entry.asm"
	even