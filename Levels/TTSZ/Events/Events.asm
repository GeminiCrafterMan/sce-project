...
TTSZ1_BackgroundInit:
		bsr.w	TTSZ_Deform
		jsr	(Reset_TileOffsetPositionEff).w
		jsr	(Refresh_PlaneFull).w
		bra.s	TTSZ1_BackgroundEvent.deform

; =============== S U B R O U T I N E =======================================

TTSZ1_BackgroundEvent:
		tst.b (Background_event_flag).w
		bne.s	TTSZ1_Transition
		bsr.w	TTSZ_Deform

.deform:
		lea	TTSZ1_BGDeformArray(pc),a4
...
.index:	dc.w .exit-.index
		dc.w DWE_TTSZ2-.index
		dc.w DWE_TTSZ3-.index
		dc.w DWE_TTSZ4-.index
; ===========================================================================
