WZ_DoAniPLC:
	...
	subq.b	#1,d0
	andi.b	#3,d0
	lea	(Art_WzPoison2).l,a4 ; load lava patterns
	ror.w	#7,d0
	adda.w	d0,a4
...
AniPLC_WZ:	zoneanimstart
	;poison surface
	zoneanimdecl -1, (Art_WzPoison1>>1), $33D, 3, 8
	dc.b   0,$13
	dc.b   8,$13
	dc.b  16,$13
	zoneanimend