...
StartLocArray:
	; Intro Stages
		...
		binclude "Levels/Intro Stages/Green Hill/Start Location/EX.bin"	; Green Hill EX
		binclude "Levels/Intro Stages/Techno Tower/Start Location/EX.bin"; Techno Tower EX
