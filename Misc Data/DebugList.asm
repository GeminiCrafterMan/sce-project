...
.DEZ1: dbglistheader
	...
	dbglistobj Obj_Spring, Map_RedSpring, $81, 0, make_art_tile(ArtTile_Spring,0,0)
	dbglistobj Obj_Spring, Map_YellowSpring, $82, 0, make_art_tile(ArtTile_Spring,0,0)
	dbglistobj Obj_Spring, Map_RedSpring, $90, 3, make_art_tile(ArtTile_Spring,0,0)
	dbglistobj Obj_Spring, Map_YellowSpring, $92, 3, make_art_tile(ArtTile_Spring,0,0)
	dbglistobj Obj_Spring, Map_RedSpring, $A0, 6, make_art_tile(ArtTile_Spring,0,0)
	dbglistobj Obj_Spring, Map_YellowSpring, $A2, 6, make_art_tile(ArtTile_Spring,0,0)
